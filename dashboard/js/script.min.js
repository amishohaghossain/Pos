...
app.config({
    ...
    smoothScroll: !1,
    saveState: !1
}), app.dir.vendor = "http://localhost:3000/assets/vendor/", app.ready(function() {
        ...
        $("#theadmin-search input").typeahead(null, {
            ...
            templates: {
                suggestion: function(a) {
                    return '<a href="' + location.origin + "/" + a.url + '"><h6 class="mb-1">' + a.title + "</h6><small>" + a.description + "</small></a>"
                }
            }
        }), $("#theadmin-search input").bind("typeahead:select", function(a, b) {
            window.location.href = location.origin + "/" + b.url
